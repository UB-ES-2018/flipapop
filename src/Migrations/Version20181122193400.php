 ...
 */
final class Version20181122193400 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE product ADD visibility INT NOT NULL');
        $this->addSql('ALTER TABLE product ADD num_likes INT NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE product ADD sold BOOLEAN NOT NULL DEFAULT false');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product DROP visibility');
        $this->addSql('ALTER TABLE product DROP num_likes');
